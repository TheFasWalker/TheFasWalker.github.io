...
export const ProfilePage = () => {
    ...
    const {error, isLoading,profile}= useAppSelector((state)=>state.profileReduser)
    const { error: categoryError, isLoading: categoryIsLoading, data:as } = useAppSelector((state) => state.categoryReduser)
    ...
    return (
        <>
            <PopupWrapper
                visible={creatingCategoryPopup}
                close={()=>setCreatingCategoryPopup(!creatingCategoryPopup)}>
                <CreateCategoryForm
                    close={() => setCreatingCategoryPopup(!creatingCategoryPopup)}
                    token={token}
                />
