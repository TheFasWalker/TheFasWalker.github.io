...
export const OperationsDetail: FC<operationDetailsProps> = ({ token,id, close, visible, deleteElem, editFormVisibility, openFormVisibility, closeFormVisibility }) => {
...
{token &&
            <div className={cl.buttons}>
                ...
                onClick={()=>deleteItem()}/>
                <EditButton
                onClick={()=>openFormVisibility()}/>
            </div>}
      </div>
:
        <EditOperation
          operation={operationElement}
        closeEdition={()=>closeFormVisibility()}
        />
      }
    </PopupWrapper>
  );
